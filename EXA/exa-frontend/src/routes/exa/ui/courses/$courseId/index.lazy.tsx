                ...
                <div className="space-y-4">
                  {courseLectures.map((lecture) => {
                    ...
                    return (
                        <Link
                            key={lecture.id}
                            to="/exa/ui/lecture/edit/$lectureId"
                            params={{ lectureId: lecture.id || '' }}
                            className={`block p-4 rounded-lg border ${isUpcoming ? 'bg-white border-blue-200' : 'bg-gray-50 border-gray-200'} hover:border-blue-300 cursor-pointer transition-colors`}
                        >
                            <div className="flex justify-between items-start mb-2">
