...
import { parseCoursesXml, parseExamsXml, parseLecturersXml } from '../../../../lib/utils'
...
function ExamDetailComponent() {
    ...
    if (coursesLoading || lecturersLoading || examsLoading) {
        return (
    ...
    if (!coursesData || !lecturersData || !examsData) {
        return (
            ...
            <div className="mb-8">
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <span className={`px-4 py-2 rounded-full text-sm font-medium ${isUpcoming ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'}`}>
