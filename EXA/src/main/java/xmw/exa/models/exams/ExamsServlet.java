...
public class ExamsServlet extends ExaServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // response.sendRedirect(Config.BASE_URL + "/exams" + (queryString != null ? "?"
        // + queryString : ""));
        // return;
        // }
        //
        ...
        // .append("
        // <room_or_link>").append(exam.getRoomOrLink()).append("</room_or_link>\n")
        // .append(" </exam>\n");
        // }
        //
        // xmlBuilder.append("</exams>");
        ...
        // request.setAttribute("courses", new
        // CourseRepository(DB.getInstance().getContext()).all());
        //
        ...
        //
        // message.append("<li>")
        // .append("<a href=\"" + Config.BASE_URL +
        // "/exams/").append(exam.getId()).append("\">")
        ...
        // .append(" for ")
        // .append("<a href=\"" + Config.BASE_URL +
        // "/courses/").append(course.getId()).append("\">")
...
////                                    :
        ...
        // request.getRequestDispatcher("/WEB-INF/collection.jsp");
        // try {
